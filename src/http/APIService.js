...
app
const API_URL = 'https://nthies.pythonanywhere.com/';/* 'http://localhost:8000'
http://127.0.0.1:8000 or 'https://yourPythonAnywhereName.pythonanywhere.com' 'https//nthies.pythonanywhere.com'*/
