        ...
        <div class="card">
          <div class="row">
            <div class="col-md-6 d-none d-xl-block d-lg-block d-md-block">
              <img :src="require('@/assets/movie_logo.jpg')" class="img-fluid"
            ...
            <div class="col-md-6">
              <div class="card-body">
                ...
                <a v-if="this.authenticated === 'true'" @click="viewMovies"
                   class="btn btn-primary">View Details</a>
                <a v-else @click="login" class="btn btn-primary">Login to View
                  Details</a>
              </div>
            </div>
          </div>
