                ...
                <form ref="form">
                  <div class="container-fluid">
                    <div class="form-group row justify-content-around py-2">
                      ...
                      <div class="col col-7">
                        <input v-model="movie.name" type="text" class="form-controlsm form-control">
                      </div>
                    </div>
                    <div class="form-group row justify-content-around py-2">
                      <label class="col-5">Description</label>
                      <div class="col col-7">
                        <input v-model="movie.description" type="text" class="formcontrol-sm form-control">
                      </div>
                    </div>
                    <div class="form-group row justify-content-around py-2">
                    ...
                    <div class="row justify-content-around">
                      ...
                      <div v-if="isUpdate" type="button" class="btn btn-primary col4" @click="updateMovie">Update</div>
